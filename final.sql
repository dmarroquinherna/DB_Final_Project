...
-- Schema final_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `final_db` DEFAULT CHARACTER SET utf8;
USE `final_db`;

-- -----------------------------------------------------
-- Table `final_db`.`Memberships`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Memberships` (
...
-- -----------------------------------------------------
-- Table `final_db`.`Clients`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Clients` (
  ...
  CONSTRAINT `fk_Clients_Memberships`
    ...
    REFERENCES `final_db`.`Memberships` (`membership_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `final_db`.`Employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Employees` (
...
-- -----------------------------------------------------
-- Table `final_db`.`Classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Classes` (
  ...
  CONSTRAINT `fk_Classes_Employees1`
    ...
    REFERENCES `final_db`.`Employees` (`employee_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `final_db`.`Class_Registrations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Class_Registrations` (
  ...
  CONSTRAINT `fk_Class_Registrations_Clients1`
    ...
    REFERENCES `final_db`.`Clients` (`client_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Class_Registrations_Classes1`
    FOREIGN KEY (`Classes_class_id`)
    REFERENCES `final_db`.`Classes` (`class_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `final_db`.`Invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Invoices` (
...
-- -----------------------------------------------------
-- Table `final_db`.`Nutrition_Products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Nutrition_Products` (
  ...
  CONSTRAINT `fk_Nutrition_Products_Invoices1`
    ...
    REFERENCES `final_db`.`Invoices` (`invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `final_db`.`Equipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `final_db`.`Equipment` (
